        ...
        <NavListContainer open={this.state.open}>
          <NavList>
            <NavSub>
              <p>
                FOLLOW
                <SocialLink target="_blank" rel="nofollow noopener noreferrer" href="https://www.twitter.com/isthatjeff" alt="Twitter">
                  <svg
                    fillRule="evenodd"
                ...
                <SocialLink target="_blank" rel="nofollow noopener noreferrer" href="https://www.instagram.com/_isthatjeff" alt="Instagram">
                  <svg
                    fillRule="evenodd"
                    strokeLinejoin="round"
                    strokeMiterlimit="1.414"
